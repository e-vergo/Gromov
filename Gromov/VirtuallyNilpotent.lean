...
private def quotientIsCyclic {G : Type*} [Group G] (H K : Subgroup G)
  ...
  | succ n ih =>
    ...
    · -- g is in the center.
      ...
      · -- g is not in the commutator subgroup, so gbar ≠ 1 in H^ab
        ...
        --
        -- Let's use this as an axiom for now and complete the rest of the proof
        sorry
...
/-- Helper predicate for virtualNilpotencyClass definition. -/
private def hasNilpotentSubgroupOfClassLE (G : Type*) [Group G] (n : ℕ) : Prop :=
